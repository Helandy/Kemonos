...
internal fun SettingUiScreen(
    ...
    SettingsScreenScaffold(
        ...
        GeneralSettingsSection(
            ...
            onShowKemono = { onEvent(Event.ChangeViewSetting.ShowKemono(it)) },
            showCoomer = ui.showCoomer,
            onShowCoomer = { onEvent(Event.ChangeViewSetting.ShowCoomer(it)) },
            defaultSite = ui.defaultSite,
            onDefaultSite = { onEvent(Event.ChangeViewSetting.DefaultSite(it)) },
