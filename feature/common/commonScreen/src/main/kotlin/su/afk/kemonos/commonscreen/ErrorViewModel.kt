...
import su.afk.kemonos.commonscreen.navigator.ErrorNavigatorDest
import su.afk.kemonos.navigation.NavigationManager

internal class ErrorViewModel @AssistedInject constructor(
    @Assisted private val dest: ErrorNavigatorDest,
    ...
    @AssistedFactory
    interface Factory {
        fun create(dest: ErrorNavigatorDest): ErrorViewModel
    }
