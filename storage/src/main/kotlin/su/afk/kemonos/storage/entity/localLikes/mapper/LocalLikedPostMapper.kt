package su.afk.kemonos.storage.entity.localLikes.mapper
...
@Singleton
internal class LocalLikedPostMapper @Inject constructor(
    ...
    fun toEntity(site: SelectedSite, domain: PostDomain, now: Long = System.currentTimeMillis()): LocalLikedPostEntity =
        LocalLikedPostEntity(
            site = site,
    ...
    fun toDomain(entity: LocalLikedPostEntity): PostDomain =
        PostDomain(
            id = entity.id,
